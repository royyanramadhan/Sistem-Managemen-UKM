...
<div class="max-w-3xl space-y-6">
    ...
    <div class="card p-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-slate-500 mt-1 text-sm">Isi form berikut untuk menambahkan berita baru.</p>
        </div>
    ...
    <div class="card p-6">
        <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Format: JPEG, PNG, WebP. Maks: 3 MB.</p>
            ...
            <div>
                ...
                <textarea name="isi" rows="8" required placeholder="Tulis isi berita di sini..."
                    class="w-full px-4 py-2.5 border border-black focus:outline-none text-sm resize-y @error('isi') border-red-500 @enderror">{{ old('isi') }}</textarea>
            ...
            <div class="flex items-start gap-3 p-4 border border-black bg-slate-50">
                ...
                <input type="checkbox" name="tampil_di_dashboard" id="tampil_di_dashboard" value="1"
                    {{ old('tampil_di_dashboard') ? 'checked' : '' }}
